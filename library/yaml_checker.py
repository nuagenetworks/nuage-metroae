...
def check_yaml(filepath):
	...
	module.exit_json(changed=False)
	 ...
	 print("Error while parsing YAML file:")
		...
		if exc.context!=None:
			msg1 ="YAML Syntax Error" + str(exc.problem_mark) + ":" + str(exc.problem) + str(exc.context) + "--- Please correct data and retry."
			print(msg1)
			module.fail_json(msg=msg1)
		else:
			msg1="YAML Syntax Error" + str(exc.problem_mark) + " : " + str(exc.problem) + "--- Please correct data and retry."
			module.fail_json(msg=msg1)
	 else:
		module.fail_json(msg = "Something went wrong while parsing yaml file")
