...
openstack image show snapshot_final_test --os-username=NI_NME_SERVICES_DELIVERYAUTOMATION_CLOUD --os-project-id=f36f2db6bb434484b71a45aa84b9d790 --os-project-domain-id=default --os-user-domain-id=default --os-password=casoCASO1$ --os-project-name=NI_NME_SERVICES_DELIVERYAUTOMATION_CLOUD --os-auth-url=http://ch-dc-os-gsn-32.eecloud.nsn-net.net:5000/v3