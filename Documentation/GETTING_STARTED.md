...
Please note that this is only a requirement for target servers that are KVMs. Passwordless SSH is not required for the other target-server types: AWS, Openstack, and vCenter.
