...
# This file has been copied from ansible/modules/cloud/vmware/vsphere_copy.py
# There is currently an unresolved defect in this module (issue 58168) where
# it errors out with IndexError.  We are copying this module out and adding a
# band-aid fix until it is resolved for real in Ansible code.  When Ansible
# has properly resolved this issue, the original vsphere_copy can be used
# again.
...
DOCUMENTATION = '''
---
module: vsphere_copy_ansible_issue_58168
