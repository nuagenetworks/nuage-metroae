...
# example of metadata to be added in VSD WAN Service: "rd=3:3,vprnAS=65000,vprnRD=65000:1,vprnRT=target:65000:1,vprnLo=1.1.1.1,customer=pepsi,customeras=640001,customerip=2.2.2.2,customerpass=password,customersubnet=192.168.1.0/31,customersap=1.1.1:10"
...
# remove trailing space at the end of the metadata
    ...
    if servicetype == "VRF-VXLAN":
      ...
      print ('servicetype, VPLS id, rt, vni, rd, VPRN id, vprn_AS, vprn_RD, vprn_RT, vprn_Lo, customer, customeras, customerip, customerpass, customersubnet, customersap:', servicetype, vplsSvc_id, rt, vni, rd, vprnSvc_id, vprn_AS, vprn_RD, vprn_RT, vprn_Lo, customer, customeras, customerip, customerpass, customersubnet, customersap)
      dyn.add_cli("""
      ...
      return {'vplsSvc_id' : vplsSvc_id, 'vprnSvc_id' : vprnSvc_id, 'servicetype' : servicetype, 'vni' : vni, 'vprn_AS' : vprn_AS, 'vprn_RD' : vprn_RD, 'vprn_RT' : vprn_RT, 'vprn_Lo' : vprn_Lo, 'customer' : customer, 'customeras' : customeras, 'customerip' : customerip, 'customerpass' : customerpass, 'customersubnet' : customersubnet, 'customersap' : customersap}
