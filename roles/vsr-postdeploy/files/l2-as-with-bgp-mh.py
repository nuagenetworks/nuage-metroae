...
# example of metadata to be added in VSD WAN Service: "rd=1:1,sap=1/1/3:1000,opergroup=group-PE1"
...
# teardown example cli: tools perform service vsd evaluate-script domain-name "l2dom1" type l2-domain action teardown policy "py-l2-red" vni 1234 rt-i target:1:1 rt-e target:1:1
...
# remove trailing space at the end of the metadata
    ...
    if servicetype == "L2DOMAIN":
      ...
      # L2DOMAIN returns setupParams: vplsSvc_id, servicetype, vni, sdp, opergroup
      return {'vplsSvc_id' : vplsSvc_id, 'servicetype' : servicetype, 'vni' : vni, 'sap' : sap, 'opergroup' : opergroup}
